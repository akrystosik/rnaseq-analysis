    ...
    for subject_dir in subject_dirs:
        ...
        for file_path in csv_files:
            ...
            try:
                ...
                # (For ADNI we derive the subject ID from the directory name)
                metadata = {
                    "sample_id": sample_id,
                    "subject_id": subject_id,
                    "dataset": "ADNI",
                    "data_type": "RNA-seq",  # TPM values from RNA-seq
                    "expression_unit": "TPM",
                    "tissue": "blood",  # Default; change if tissue info available
