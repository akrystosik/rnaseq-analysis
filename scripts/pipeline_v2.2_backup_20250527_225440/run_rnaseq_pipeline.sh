...
# --- Final Message ---
log_message "=== RNA-seq Pipeline Processing Complete (Stages 0-4) ==="
log_message ""
log_message "Optional: To process GTEx single-cell data, run:"
log_message "  ${SCRIPTS_DIR}/single_cell/run_process_gtex_single_cell.sh"
