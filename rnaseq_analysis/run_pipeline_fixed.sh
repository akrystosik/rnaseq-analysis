#!/bin/bash
# RNA-seq Analysis Pipeline Execution Script (FIXED)
...
# Default values
BASE_DIR="/mnt/czi-sci-ai/intrinsic-variation-gene-ex/rnaseq_analysis_new"
INCLUDE_ENTEX=false
NUM_DATASETS=""
USE_LOG=false
...
# Skip setup since we've already done it
log "Step 1: Skipping setup as already completed"
...
# Run with PYTHONPATH set for the command
PYTHONPATH=$PYTHONPATH:$BASE_DIR/src eval "$ANALYSIS_CMD" | tee -a "$LOG_FILE"
